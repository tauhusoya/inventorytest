...
export default function Create() {
    ...
    const submit = (e) => {
        ...
        post(route('items.store'), {
            onError: (errors) => {
                ...
                if (errors.item_id && errors.item_id.includes('already been taken')) {
                    toast.error('Item ID already exists. Please use a different Item ID.');
                } else {
                    toast.error('Failed to create item. Please check the form and try again.');
                }
            },
        });
    };
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Add New Item</h2>}
        >
